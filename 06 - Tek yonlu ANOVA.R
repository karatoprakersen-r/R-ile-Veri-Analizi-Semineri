...
#Dean, A., Voss, D. ve Draguljić, D. (2017). Design and Analysis of Experiments. Springer-Verlag New York. doi:10.1007/978-3-319-52250-0
...
#`emmeans` kütüphanesinden `lsmeans()` fonksiyonu en küçük kareler ortalaması (least squares means) 
...
#Varsayımların sağlanmadığı durumlar için Transformations ve  Games–Howell yöntemi uygulanır.
#Kaynak:
#Dean, A., Voss, D. ve Draguljić, D. (2017). Design and Analysis of Experiments. Springer-Verlag New York. doi:10.1007/978-3-319-52250-0
