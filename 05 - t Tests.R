...
#Normalden sapan dağılım örneklerinin Q-Q plot ile gösterimi için  Statistical Analysis and Data Display An Intermediate Course with Examples in R bölüm 5.8.1'e bakılabilir.
